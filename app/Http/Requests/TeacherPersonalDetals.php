...
class TeacherPersonalDetals extends FormRequest
{
    ...
    public function rules()
    {
        $rules =  [
            ...
            'teachers_teacher_licenseno'            => 'nullable',
            'teachers_teacher_licensestep'          => 'nullable',
            'teachers_teacher_license_sub'          => 'nullable',
            'teachers_teacher_licenseno_jari_date'  => 'nullable',
