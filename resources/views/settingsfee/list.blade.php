  ...
  <div class="col-lg-12">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-custom">
        ...
        <li class="breadcrumb-item active">Student Fee Settings</li>
      </ol>
    </nav>
            ...
            <thead class="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('delete-studentfee', $gradeId) }}"
                              method="POST"
                              onsubmit="return confirm('Are you sure you want to delete all fees for this grade?');">
                            @csrf
                            @method('DELETE')
