    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        @if($ledgerPayments->count())
          @php
            $student = $ledgerPayments->first()->teacher;
          @endphp

          <div class="row mb-3">
            <div class="col-md-4">
              <strong>Name:</strong> {{ $student->teachers_name_eng }}
            </div>
            <div class="col-md-4">
              <strong>Grade:</strong> {{ $student->teaching_grade }}
            </div>
            <div class="col-md-4">
        ...
        <a href="{{ route('paid-teacher-details-ledgerPrint', $ledgerPayments->first()->teachers_id) }}"
            target="_blank"
        ...
        {{-- ================= BACK BUTTON ================= --}}
        <a href="{{ route('salarypaid-teachers-details') }}" class="btn btn-secondary">
