...
<html>
<head>
    <title>Teacher Salary Ledger</title>
...
<div class="header">
    <h3 class="text-center">TEACHER SALARY LEDGER</h3>
    <p><strong>Name:</strong> {{ $student->teachers_name_eng }}</p>
    <p><strong>Grade:</strong> {{ $student->teaching_grade }}</p>
